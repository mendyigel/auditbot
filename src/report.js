...
<head>
  ...
  <title>AuditBot Report — ${escHtml(audit.url)}</title>
  <style>
...
<footer>Generated by <strong>AuditBot</strong> · ${audit.auditedAt}</footer>
</body>
</html>`;
}
...
function errorPage(audit) {
  return `<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><title>AuditBot Error</title></head>
